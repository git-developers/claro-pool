 ...
 */
class Version20180506134216 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE pasajero_has_route (id INT AUTO_INCREMENT NOT NULL, route_id INT DEFAULT NULL, user_id INT DEFAULT NULL, nro_of_seats INT DEFAULT NULL, INDEX fk_pasajero_has_route_user1_idx (user_id), INDEX fk_pasajero_has_route_route1_idx (route_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pasajero_has_route ADD CONSTRAINT FK_466BE66E34ECB4E6 FOREIGN KEY (route_id) REFERENCES route (id_increment)');
        $this->addSql('ALTER TABLE pasajero_has_route ADD CONSTRAINT FK_466BE66EA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE pasajero_has_route DROP FOREIGN KEY FK_466BE66E34ECB4E6');
        ...
        $this->addSql('ALTER TABLE pasajero_has_route DROP FOREIGN KEY FK_466BE66EA76ED395');
        ...
        $this->addSql('DROP TABLE pasajero_has_route');
