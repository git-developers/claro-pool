...
(function($) {
    ...
    $.formEmpezarCarrera = function(el, options) {
        ...
        base.$el = $(el);
        base.el = el;
        base.$el.data('formEmpezarCarrera', base);
    ...
    // $.formEmpezarCarrera.defaultOptions = {
    //     buttonStyle: "border: 1px solid #fff; background-color:#000; color:#fff; padding:20px 50px",
    //     buttonPress: function () {}
    // };

    $.fn.formEmpezarCarrera = function(options){

        return this.each(function(){

            var bp = new $.formEmpezarCarrera(this, options);
...
(function($) {
    ...
    $.formFinalizar = function(el, options) {
        ...
        base.$el = $(el);
        base.el = el;
        base.$el.data('formFinalizar', base);
    ...
    // $.formFinalizar.defaultOptions = {
    //     buttonStyle: "border: 1px solid #fff; background-color:#000; color:#fff; padding:20px 50px",
    //     buttonPress: function () {}
    // };

    $.fn.formFinalizar = function(options){

        return this.each(function(){

            var bp = new $.formFinalizar(this, options);
